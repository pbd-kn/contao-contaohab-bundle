...
$GLOBALS['TL_LANG']['tl_coh_geraete']['pushRaspberryConfig'] = ['Konfiguration zum Raspberry übertragen', 'Überträgt alle Geräte, aktiven Sensoren und Collector-Einstellungen per HTTPS zum Raspberry.'];
$GLOBALS['TL_LANG']['tl_coh_geraete']['pushRaspberryConfigConfirm'] = 'Geräte und aktive Sensoren jetzt zum Raspberry übertragen?';
$GLOBALS['TL_LANG']['tl_coh_geraete']['pullRaspberryConfig'] = ['Konfiguration vom Raspberry holen', 'Übernimmt Geräte, Sensoren und Collector-Einstellungen vom Raspberry in die lokale Datenbank.'];
