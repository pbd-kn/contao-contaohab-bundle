...
$GLOBALS['TL_DCA']['tl_coh_sensorcollector_settings'] = [
    ...
    'fields' => [
        ...
        'storageProRaspberryBaseUrl' => ['inputType' => 'text', 'eval' => ['maxlength' => 255, 'tl_class' => 'w50'], 'sql' => "varchar(255) NOT NULL default 'https://p1pu92iv4i9yh2m2.myfritz.net'"],
        ...
        'wasserLeckageRaspberryBaseUrl' => ['inputType' => 'text', 'eval' => ['maxlength' => 255, 'tl_class' => 'w50'], 'sql' => "varchar(255) NOT NULL default 'https://p1pu92iv4i9yh2m2.myfritz.net'"],
