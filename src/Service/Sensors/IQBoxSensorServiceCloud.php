...
final class IQBoxSensorServiceCloud implements SensorFetcherInterface
{
    ...
    public function __construct(
        ...
        private readonly string $ampereClParamsFile = '',
        private readonly string $ampereClUsername = '',
        private readonly string $ampereClPassword = '',
        private readonly int $ampereClRetries = 3,
        private readonly int $ampereClRetryDelay = 10,
        private readonly int $ampereClLifetimeCacheSeconds = 60,
    ) {
    }

    public function supports(SensorModel $sensor): bool
    {
        return strtolower((string) $sensor->sensorSource) === 'iqboxcl';
    }
