...
namespace PbdKn\ContaoContaohabBundle\Controller\FrontendModule;
...
#[AsFrontendModule(category: 'contao_hab', template: 'mod_display_things')]
class DisplayThingsController extends AbstractFrontendModuleController
{
    public const TYPE = 'display_things';
